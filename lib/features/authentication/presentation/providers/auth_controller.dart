  ...
  Future<void> checkExistingAuth() async {
    try {
      final token = await repository
          .getSavedUserToken(); //The method 'getSavedUserToken' isn't defined for the type 'AuthRepository'.
      // Try correcting the name to the name of an existing method, or defining a method named 'getSavedUserToken'.
